...
create_and_configure_core -download_core -core_vlnv {Actel:DirectCore:COREAXI4INTERCONNECT:*} -component_name {FIC0_INITIATOR} -params {\
"ADDR_WIDTH:38"  \
"CROSSBAR_MODE:0"  \
"DATA_WIDTH:64"  \
