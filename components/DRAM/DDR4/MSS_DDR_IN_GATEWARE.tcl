puts "======== Add MSS DDR in GATEWARE option: DDR4 ========"
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ACT_N"   "BVF_RISCV_SUBSYSTEM:ACT_N"   }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BG0"     "BVF_RISCV_SUBSYSTEM:BG0"     }
